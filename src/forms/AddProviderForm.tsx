  ...
  return (
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <Grid container spacing={1} sx={{ p: 2 }}>
        <Grid size={12}>
          <CustomLabel variant="body14PX500FW" label="Demographic" color="neutral.80" />
        </Grid>

        <Grid size={{xs:12, md:6}}>
          <CustomLabel label="First Name" variant="body5Medium" color="neutral.60" />
          <Controller
            name="firstName"
            control={control}
            render={({ field }) => (
        ...
        <Grid size={{xs:12, md:6}}>
          <CustomLabel label="Last Name" variant="body5Medium" color="neutral.60" />
          <Controller
            name="lastName"
            control={control}
            render={({ field }) => (
        ...
        <Grid size={{xs:12, md:6}}>
          <CustomLabel label="NPI Number" variant="body5Medium" color="neutral.60" />
          <Controller
            name="npiNumber"
            control={control}
            render={({ field }) => (
        ...
        <Grid size={{xs:12, md:6}}>
          <CustomLabel label="Email" variant="body5Medium" color="neutral.60" />
          <Controller
            name="email"
            control={control}
            render={({ field }) => (
        ...
        <Grid size={{xs:12, md:6}}>
          <CustomLabel label="Phone Number" variant="body5Medium" color="neutral.60" />
          <Controller
            name="phoneNumber"
            control={control}
            render={({ field }) => (
        ...
        <Grid size={{xs:12, md:6}}>
          <CustomLabel label="Location" variant="body5Medium" color="neutral.60" />
          <Controller
            name="location"
            control={control}
            render={({ field }) => (
        ...
        <Grid size={{xs:12}}><Divider sx={{ my: '20px', color: 'neutral.5' }} /></Grid>
        ...
        <Grid size={{xs:12, md:6}}>
          <CustomLabel label="State" variant="body5Medium" color="neutral.60" />
          <Controller
            name="licenseState"
            control={control}
            render={({ field }) => (
        ...
        <Grid size={{xs:12, md:6}}>
          <CustomLabel label="License Number" variant="body5Medium" color="neutral.60" />
          <Controller
            name="licenseNumber"
            control={control}
            render={({ field }) => (
        ...
        <Grid size={{xs:12, md:6}}>
          <CustomLabel label="Expiry Date" variant="body5Medium" color="neutral.60" />
          <Controller
            name="expiryDate"
            control={control}
            render={({ field }) => (
        ...
        <Grid size={{xs:12, md:6}}>
          <CustomLabel label="Address Line 1" variant="body5Medium" color="neutral.60" />
          <Controller
        ...
        <Grid size={{xs:12, md:4}}>
          <CustomLabel label="City" variant="body5Medium" color="neutral.60" />
          <Controller
            name="physicalCity"
            control={control}
            render={({ field }) => (
        ...
        <Grid size={{xs:12, md:4}}>
          <CustomLabel label="ZIP" variant="body5Medium" color="neutral.60" />
          <Controller
            name="physicalZip"
            control={control}
            render={({ field }) => (

...
import { addLocationSchema, type AddLocationFormValues } from './validations/schema';
...
const AddLocationForm = ({ onClose }: { onClose?: () => void }) => {
    ...
    const { handleSubmit, reset, setValue, watch, control, formState: { errors } } = useForm<AddLocationFormValues>({
        defaultValues,
    ...
    const onSubmit: SubmitHandler<AddLocationFormValues> = (data) => {

...
import PatientDemographicsCareTeamList from './patient-demographics-care-team/patient-demographics-care-team-list';

const tabs = ['Vitals', 'Alerts', 'Task', 'Care Team', 'Documents', 'Time Log', 'Billing'];
  ...
  return (
    <Grid container width={'100%'} flexDirection={'column'} rowGap={2} p={1.7}>
      ...
      <Grid container width={'100%'}>
        ...
        {tabValue === 3 && <PatientDemographicsCareTeamList />}
      </Grid>
    </Grid>
  );
};
